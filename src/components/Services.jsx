...
const generalServices = [
  ...
  },
  {
    ...
    description: 'Flexible labour for construction sites, demolition projects, heavy lifting, and general site support. Experienced operatives who integrate seamlessly with your existing crews in active environments.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
